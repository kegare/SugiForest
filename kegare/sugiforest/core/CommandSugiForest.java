...
public class CommandSugiForest implements ICommand
{
	@Override
	...
	public void processCommand(ICommandSender sender, String[] args)
	{
		...
		{
			message.append(EnumChatFormatting.DARK_GREEN).append(" SugiForest ").append(EnumChatFormatting.RESET);
		...
		{
			message.append(" SugiForest ").append(Version.CURRENT.orNull()).append(" for ").append(Loader.instance().getMCVersionString());
		...
		sender.sendChatToPlayer(ChatMessageComponent.createFromText("  " + SugiForest.metadata.description));
		sender.sendChatToPlayer(ChatMessageComponent.createFromText("  " + SugiForest.metadata.url).setColor(EnumChatFormatting.DARK_GRAY));
	}
